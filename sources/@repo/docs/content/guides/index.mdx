...
<div className="card">
  <div className="card__body">
    <ul>
      <li>node.js runtime >=18.12.1 (LTS)</li>
      <li>yarn >=1.22 or npm >=8.3</li>
...
If you are using pnpm you will need to add `--public-hoist-pattern=*` to the installation command.
